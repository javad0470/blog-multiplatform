(function (root, factory) {
  ...
  var trimStart = kotlin_kotlin.$_$.lc;
  ...
  var substringAfterLast = kotlin_kotlin.$_$.vb;
  ...
  var drop = kotlin_kotlin.$_$.bb;
  var first = kotlin_kotlin.$_$.fb;
  ...
  var startsWith_0 = kotlin_kotlin.$_$.ub;
  ...
  function ApiFetcher(window_0) {
    this.e3g_1 = window_0;
    this.f3g_1 = logOnError$factory(get_http(this.e3g_1));
    this.g3g_1 = 8;
  }
  protoOf(ApiFetcher).h3g = function (_set____db54di) {
    logOnError$factory_0();
    return this.f3g_1.set(_set____db54di);
  };
  protoOf(ApiFetcher).i3g = function () {
    // Inline function 'kotlin.getValue' call
    logOnError$factory_1();
    return this.f3g_1.get();
  };
  protoOf(ApiFetcher).j3g = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.e3g_1).d2o(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).k3g = function (apiPath, headers, body, abortController, autoPrefix, $completion, $super) {
    ...
    return $super === VOID ? this.j3g(apiPath, headers, body, abortController, autoPrefix, $completion) : $super.j3g.call(this, apiPath, headers, body, abortController, autoPrefix, $completion);
  };
  ...
  function KobwebApp$composable(content, $composer, $changed) {
    ...
    if (!(($dirty & 11) === 2) ? true : !$composer_0.ky()) {
      ...
      Style$composable(null, tmp0_Style$composable.o29(), $composer_1, 0, 1);
      $composer_1.oy();
  ...
  function DefaultStyleSheet() {
    ...
    this.t29('html, body', DefaultStyleSheet$lambda);
    this.t29('*', DefaultStyleSheet$lambda_0);
    this.p3g_1 = 0;
  }
  protoOf(DefaultStyleSheet).s29 = function (selector, cssRule) {
  ...
  function RouteInfo(route, dynamicParams) {
    this.q3g_1 = route;
    this.r3g_1 = dynamicParams;
    this.s3g_1 = substringAfterLast(this.q3g_1.z3g_1, _Char___init__impl__6a9atx(47));
    this.t3g_1 = this.q3g_1.z3g_1;
    this.u3g_1 = plus(this.q3g_1.a3h_1, this.r3g_1);
    this.v3g_1 = this.q3g_1.a3h_1;
    this.w3g_1 = this.q3g_1.b3h_1;
    this.x3g_1 = 0;
  }
  protoOf(RouteInfo).toString = function () {
    return this.q3g_1.toString();
  };
  protoOf(RouteInfo).equals = function (other) {
    ...
    if (other instanceof RouteInfo) {
      tmp_1 = other.t3g_1 === this.t3g_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = equals(other.u3g_1, this.u3g_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = other.w3g_1 == this.w3g_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(RouteInfo).hashCode = function () {
    ...
    result = imul(31, result) + hashCode(this.u3g_1) | 0;
  ...
  protoOf(RouteInfo).d3h = function (path, queryParams, fragment, dynamicParams) {
    return new RouteInfo(Route_init_$Create$(path, queryParams, fragment), dynamicParams);
  };
  protoOf(RouteInfo).e3h = function (path, queryParams, fragment, dynamicParams, $super) {
    path = path === VOID ? this.q3g_1.z3g_1 : path;
    queryParams = queryParams === VOID ? this.q3g_1.a3h_1 : queryParams;
    fragment = fragment === VOID ? this.q3g_1.b3h_1 : fragment;
    dynamicParams = dynamicParams === VOID ? this.r3g_1 : dynamicParams;
    return $super === VOID ? this.d3h(path, queryParams, fragment, dynamicParams) : $super.d3h.call(this, path, queryParams, fragment, dynamicParams);
  };
  function Companion() {
    Companion_instance = this;
  }
  protoOf(Companion).g3h = function () {
    var tmp = this.f3h_1;
    if (!(tmp == null))
      return tmp;
    else {
  ...
  protoOf(Companion).h3h = function (router) {
    this.f3h_1 = new PageContext(router);
  };
  ...
  function PageContext(router) {
    ...
    this.i3h_1 = router;
    this.j3h_1 = mutableStateOf(null);
    this.k3h_1 = 8;
  }
  protoOf(PageContext).l3h = function (value) {
    this.j3h_1.ut(value);
  };
  protoOf(PageContext).m3h = function () {
    var tmp0_elvis_lhs = this.j3h_1.w1();
    var tmp;
  ...
  function MutableKobwebConfig() {
    this.q3h_1 = new MutableOpenLinkStrategies();
    this.r3h_1 = 8;
  }
  ...
  protoOf(Companion_0).v3h = function (path) {
    return !(this.w3h(path) == null);
  };
  protoOf(Companion_0).w3h = function (path) {
    var tmp;
    try {
      tmp = new Route(path);
    } catch ($p) {
  ...
  protoOf(Companion_0).x3h = function (url) {
    var tmp0_elvis_lhs = this.w3h(removePrefix(url.href, url.origin));
  ...
  function Route(pathQueryAndFragment) {
    ...
    this.y3g_1 = new URL(pathQueryAndFragment, 'http://unused.com');
    var isAbsolute = startsWith(pathQueryAndFragment, '/');
    var tmp_1 = this;
    var tmp_2;
    if (isAbsolute) {
      tmp_2 = this.y3g_1.pathname;
    } else {
      // Inline function 'kotlin.also' call
      var tmp0_also = drop(this.y3g_1.pathname, 1);
      // Inline function 'kotlin.contracts.contract' call
      ...
      // Inline function 'kotlin.check' call
      // Inline function 'kotlin.contracts.contract' call
      if (!(first(this.y3g_1.pathname) === _Char___init__impl__6a9atx(47))) {
    ...
    $l$block: {
      ...
      var tmp0_isEmpty = this.y3g_1.search;
      if (charSequenceLength(tmp0_isEmpty) === 0) {
        break $l$block;
      }
      // Inline function 'kotlin.collections.forEach' call
      var tmp0_iterator = split(removePrefix(this.y3g_1.search, '?'), charArrayOf([_Char___init__impl__6a9atx(38)])).c();
      while (tmp0_iterator.d()) {
    ...
    tmp_3.a3h_1 = tmp1_apply;
    var tmp_4 = this;
    // Inline function 'kotlin.takeIf' call
    var tmp2_takeIf = this.y3g_1.hash;
    // Inline function 'kotlin.contracts.contract' call
    var tmp_5;
    // Inline function 'com.varabyte.kobweb.navigation.Route.<anonymous>' call
    ...
    tmp_4.b3h_1 = tmp0_safe_receiver == null ? null : removePrefix(tmp0_safe_receiver, '#');
    this.c3h_1 = 8;
  }
  protoOf(Route).toString = function () {
    return this.z3g_1 + this.y3g_1.search + this.y3g_1.hash;
  };
  ...
  function prependIf(_this__u8e3s4, condition, path) {
    return condition ? Companion_getInstance_2().z3h(path) : path;
  }
  function Companion_1() {
    Companion_instance_1 = this;
  }
  protoOf(Companion_1).a3i = function (value) {
    Companion_getInstance_3().c3i(new RoutePrefixImpl(value));
  };
  protoOf(Companion_1).w1 = function () {
    return Companion_getInstance_3().g3h().d3i_1;
  };
  protoOf(Companion_1).z3h = function (path) {
    return Companion_getInstance_3().g3h().z3h(path);
  };
  ...
  protoOf(Companion_2).c3i = function (value) {
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.b3i_1 == null)) {
  ...
  protoOf(Companion_2).e3i = function () {
    if (this.b3i_1 == null) {
      this.b3i_1 = new RoutePrefixImpl('');
    }
    return this.b3i_1;
  };
  protoOf(Companion_2).g3h = function () {
    return ensureNotNull(this.e3i());
  };
  ...
  function RoutePrefixImpl(value) {
    ...
    tmp.d3i_1 = tmp2_elvis_lhs == null ? '' : tmp2_elvis_lhs;
  }
  protoOf(RoutePrefixImpl).z3h = function (path) {
    if (isBlank(this.d3i_1))
      return path;
    if (!startsWith(path, '/'))
      return path;
    return dropLast(this.d3i_1, 1) + path;
  };
  ...
  protoOf(Node).j3i = function (name) {
    return this.f3i_1 === name;
  };
  protoOf(Node).k3i = function (routePart) {
    var tmp$ret$1;
    $l$block: {
      // Inline function 'kotlin.collections.firstOrNull' call
      var tmp0_iterator = this.h3i_1.c();
      while (tmp0_iterator.d()) {
        var element = tmp0_iterator.e();
        // Inline function 'com.varabyte.kobweb.navigation.Node.findChild.<anonymous>' call
        if (element.j3i(routePart)) {
          tmp$ret$1 = element;
          break $l$block;
        }
      }
  ...
  function Node(name, method) {
    ...
    tmp.h3i_1 = ArrayList_init_$Create$_0();
    this.i3i_1 = 8;
  }
  protoOf(Node).l3i = function (routePart, method) {
    var tmp;
  ...
  protoOf(DynamicNode).j3i = function (name) {
    return true;
  };
  ...
  function resolve($this, route) {
    ...
    var currNode = $this.d3j_1;
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(routeParts.l(0) === $this.d3j_1.f3i_1)) {
    ...
    if (inductionVariable < last)
      do {
        ...
        var tmp1_elvis_lhs = currNode.k3i(routePart);
        var tmp;
  ...
  function RouteTree() {
    this.d3j_1 = new RootNode();
    this.e3j_1 = ComposableSingletons$RouteTreeKt_getInstance().f3j_1;
  }
  protoOf(RouteTree).g3j = function (route) {
    ...
    var tmp2_safe_receiver = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.b3j_1;
    return !((tmp2_safe_receiver == null ? null : tmp2_safe_receiver.g3i_1) == null);
  };
  protoOf(RouteTree).h3j = function (route) {
    var resolvedEntries = resolve(this, route.z3g_1);
    var tmp1_safe_receiver = resolvedEntries == null ? null : last(resolvedEntries);
    var tmp2_safe_receiver = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.b3j_1;
    var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.g3i_1;
    var tmp;
    ...
    if (resolvedEntries == null)
      ...
      while (tmp0_iterator.d()) {
        ...
        var tmp_0 = element.b3j_1;
        if (tmp_0 instanceof DynamicNode) {
          // Inline function 'kotlin.collections.set' call
          var tmp0_set = element.b3j_1.f3i_1;
          var tmp1_set = element.c3j_1;
  ...
  protoOf(RouteTree).i3j = function (route, method) {
    ...
    if (inductionVariable < last)
      do {
        ...
        if (tmp1_elvis_lhs == null) {
          ...
          tmp$ret$2 = tmp_1;
          tmp = tmp_0.l3i(routePart, tmp$ret$2);
        } else {
          tmp = tmp1_elvis_lhs;
        }
        currNode = tmp;
  ...
  function PageData(pageMethod, routeInfo) {
    this.j3j_1 = pageMethod;
    this.k3j_1 = routeInfo;
  }
  ...
  function ComposableSingletons$RouteTreeKt() {
    ...
    var tmp = this;
    tmp.f3j_1 = ComposableLambda$invoke$ref_0(composableLambdaInstance(-557678680, false, ComposableSingletons$RouteTreeKt$lambda_1$lambda_h43un7));
  }
  ...
  function updatePageContext(_this__u8e3s4, $this, pathQueryAndFragment) {
    if (startsWith(pathQueryAndFragment, '#')) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        _this__u8e3s4.j3h_1.ut(tmp0_safe_receiver.e3h(VOID, VOID, removePrefix(pathQueryAndFragment, '#')));
        return true;
      }
      if (tmp == null) {
        // Inline function 'kotlin.run' call
    ...
    var route = Companion_getInstance_1().w3h(pathQueryAndFragment);
    var tmp_0;
    if (!(route == null)) {
      var data = $this.m3j_1.h3j(route);
      $set_activePageMethod$$composable_u4dzqq($this, data.j3j_1);
      _this__u8e3s4.l3h(data.k3j_1);
      tmp_0 = true;
    } else {
      tmp_0 = false;
    }
  ...
  function normalize(_this__u8e3s4, $this) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!Companion_getInstance_1().v3h(_this__u8e3s4)) {
      // Inline function 'kotlin.check.<anonymous>' call
      var message = 'Check failed.';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    var hrefResolved = Companion_getInstance_1().x3h(new URL(_this__u8e3s4, window.location.href)).toString();
    // Inline function 'kotlin.takeIf' call
  ...
  function $set_activePageMethod$$composable_u4dzqq($this, set__$_ezb9bk) {
    ...
    return $this.l3j_1.ut(set__$_ezb9bk);
  }
  function Router$lambda(this$0) {
    return function (it) {
      var tmp = Companion_getInstance_0().g3h();
      var tmp$ret$1;
      // Inline function 'kotlin.let' call
  ...
  function Router$renderActivePage$composable$lambda_0($tmp0_rcvr, $pageWrapper, $$changed, $$default) {
    return function ($composer, $force) {
      $tmp0_rcvr.v3j($pageWrapper._v, $composer, updateChangedFlags($$changed | 1), $$default);
      return Unit_getInstance();
    };
  }
  function Router() {
    this.l3j_1 = mutableStateOf(null);
    this.m3j_1 = new RouteTree();
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.n3j_1 = ArrayList_init_$Create$_0();
    Companion_getInstance_0().h3h(this);
    var tmp_0 = window;
    tmp_0.onpopstate = Router$lambda(this);
    this.o3j_1 = 8;
  }
  protoOf(Router).w3j = function (interceptor) {
    this.n3j_1.a(interceptor);
  };
  protoOf(Router).x3j = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy) {
    var pathQueryAndFragment_0 = pathQueryAndFragment;
    if (Companion_getInstance_1().v3h(pathQueryAndFragment_0)) {
    ...
    var tmp;
    if (updatePageContext(Companion_getInstance_0().g3h(), this, pathQueryAndFragment_0)) {
      // Inline function 'kotlin.let' call
      var tmp1_let = window.location.origin + pathQueryAndFragment_0;
      // Inline function 'kotlin.contracts.contract' call
      if (!(window.location.href === tmp1_let)) {
        var newPathname = !(window.location.pathname === Companion_getInstance_1().x3h(new URL(tmp1_let)).z3g_1);
  ...
  protoOf(Router).y3j = function (pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy) {
    if (!this.x3j(pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy)) {
      open(window, pathQueryAndFragment, openExternalLinksStrategy);
    }
  };
  protoOf(Router).z3j = function (pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy, $super) {
    ...
    var tmp;
    if ($super === VOID) {
      this.y3j(pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy);
      tmp = Unit_getInstance();
    } else {
      tmp = $super.y3j.call(this, pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy);
    }
    return tmp;
  };
  protoOf(Router).v3j = function (pageWrapper, $composer, $changed, $default) {
    ...
    var $dirty = $changed;
    if (!(($default & 1) === 0)) {
      pageWrapper_0._v = ComposableSingletons$RouterKt_getInstance().a3k_1;
    }
    if (isTraceInProgress()) {
    ...
    var pageMethod = tmp;
    var tmp_0 = [get_PageContextLocal().n1d(Companion_getInstance_0().g3h())];
    // Inline function 'kotlin.run' call
    // Inline function 'kotlin.contracts.contract' call
  ...
  protoOf(Router).b3k = function (route, autoPrefix, pageMethod) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(Companion_getInstance_1().v3h(route) ? startsWith_0(route, _Char___init__impl__6a9atx(47)) : false)) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!this.m3j_1.i3j(prependIf(Companion_getInstance_2(), autoPrefix, route), pageMethod)) {
      // Inline function 'com.varabyte.kobweb.navigation.Router.register$composable.<anonymous>' call
      var message_0 = 'Registration failure. Path is already registered: ' + route;
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  };
  protoOf(Router).c3k = function (route, autoPrefix, pageMethod, $super) {
    autoPrefix = autoPrefix === VOID ? true : autoPrefix;
    var tmp;
    if ($super === VOID) {
      this.b3k(route, autoPrefix, pageMethod);
      tmp = Unit_getInstance();
    } else {
      tmp = $super.b3k.call(this, route, autoPrefix, pageMethod);
    }
    return tmp;
  };
  function RouteInterceptorScope(pathQueryAndFragment) {
    this.p3j_1 = new Route(pathQueryAndFragment);
    this.q3j_1 = this.p3j_1.z3g_1;
    this.r3j_1 = toMutableMap(this.p3j_1.a3h_1);
    this.s3j_1 = this.p3j_1.b3h_1;
    this.t3j_1 = 8;
  }
  protoOf(RouteInterceptorScope).d3k = function (value) {
    this.q3j_1 = startsWith_0(value, _Char___init__impl__6a9atx(47)) ? value : '/' + value;
  };
  protoOf(RouteInterceptorScope).u3j = function () {
    return Route_init_$Create$(this.q3j_1, this.r3j_1, this.s3j_1).toString();
  };
  ...
  function ComposableSingletons$RouterKt() {
    ...
    var tmp = this;
    tmp.a3k_1 = ComposableLambda$invoke$ref_4(composableLambdaInstance(-12986461, false, ComposableSingletons$RouterKt$lambda_1$lambda_cmwzz7));
  }
  ...
  protoOf(DefaultStyleSheet).r29 = style;
  protoOf(DefaultStyleSheet).t29 = style_0;
  ...
  protoOf(DefaultStyleSheet).u29 = get_hover;
  //endregion
