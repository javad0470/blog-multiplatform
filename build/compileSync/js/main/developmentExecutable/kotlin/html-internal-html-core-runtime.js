(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib-js-ir.js', './compose-multiplatform-core-runtime.js', './kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js', './kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib-js-ir.js'), require('./compose-multiplatform-core-runtime.js'), require('./kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js'), require('./kotlinx.coroutines-kotlinx-coroutines-core-js-ir.js'));
  else {
  ...
  var Companion_getInstance = kotlin_org_jetbrains_compose_runtime_runtime.$_$.m1;
  ...
  protoOf(DomNodeWrapper).insert_ftugtm_k$ = function (index, nodeWrapper) {
    ...
    if (index < length) {
      ...
      tmp$ret$1 = this.get_node_wor8sr_k$().childNodes[index];
  ...
  protoOf(DomNodeWrapper).move_xov2xr_k$ = function (from, to, count) {
    ...
    if (inductionVariable < count)
      do {
        ...
        // Inline function 'org.w3c.dom.get' call
        // Inline function 'kotlin.js.asDynamic' call
        tmp$ret$1 = this.get_node_wor8sr_k$().childNodes[fromIndex];
        var child = tmp.removeChild(ensureNotNull(tmp$ret$1));
        var tmp_0 = this.get_node_wor8sr_k$();
        var tmp$ret$3;
        // Inline function 'org.w3c.dom.get' call
        // Inline function 'kotlin.js.asDynamic' call
        tmp$ret$3 = this.get_node_wor8sr_k$().childNodes[toIndex];
