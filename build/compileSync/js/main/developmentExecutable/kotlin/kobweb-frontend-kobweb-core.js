(function (root, factory) {
  ...
  var trimStart = kotlin_kotlin.$_$.zd;
  ...
  var KMutableProperty1 = kotlin_kotlin.$_$.cc;
  ...
  var substringAfterLast = kotlin_kotlin.$_$.id;
  ...
  var sequence = kotlin_kotlin.$_$.hc;
  ...
  function get_api(_this__u8e3s4) {
    ...
    api$factory();
    return api$delegate.get_value_j01efc_k$();
  }
  var api$delegate;
  ...
  protoOf(ApiFetcher).get_logOnError_4wpkhe_k$ = function () {
    ...
    return this.logOnError$delegate_1.get();
  };
  protoOf(ApiFetcher).delete_tu9wtq_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).delete_77j3ik_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryDelete_2b4gms_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryDelete_oce7os_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).get_cszd5l_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).get_nc2n7l_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryGet_25mitb_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryGet_rtbz5r_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).head_htv8nx_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).head_jhlirb_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryHead_5zam01_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryHead_ojg9wf_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).options_ciloin_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).options_fcfhdl_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryOptions_d0gq2x_k$ = function (apiPath, headers, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryOptions_f67xfb_k$(toResource(this, apiPath, autoPrefix), headers, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).patch_q8q66x_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).patch_a99beb_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPatch_y29ru9_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryPatch_9ygkcv_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).post_yt9rwf_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).post_hpos63_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPost_6pp6ir_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryPost_q2xj1_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).put_f0z5hu_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).put_e5ym44_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  protoOf(ApiFetcher).tryPut_q4txti_k$ = function (apiPath, headers, body, abortController, autoPrefix, $completion) {
    return get_http(this.window_1).tryPut_cb2syy_k$(toResource(this, apiPath, autoPrefix), headers, body, abortController, $completion);
  };
  ...
  function Route_init_$Init$(path, queryParams, fragment, $this) {
    ...
    if (!queryParams.isEmpty_y1axqb_k$()) {
      ...
      tmp0_apply.append_ssq29y_k$(joinToString(tmp0_mapTo, '&'));
    }
    if (!(fragment == null)) {
  ...
  function Route(pathQueryAndFragment) {
    ...
    tmp_3.queryParams_1 = tmp1_apply;
    var tmp_4 = this;
  ...
  protoOf(Node).findChild_uy5y8u_k$ = function (routePart) {
    ...
    $l$block: {
      ...
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        ...
        if (element.matches_qg459u_k$(routePart)) {
          tmp$ret$1 = element;
          break $l$block;
        }
      }
  ...
  function resolve($this, route) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(routeParts.get_fkrdnv_k$(0) === $this.root_1.name_1)) {
  ...
  function _get_activePageMethod__dw5579($this) {
    ...
    return $this.activePageMethod$delegate_1.get_value_j01efc_k$();
  }
  ...
  function normalize(_this__u8e3s4, $this) {
    ...
    // Inline function 'kotlin.check' call
    // Inline function 'kotlin.contracts.contract' call
    if (!Companion_getInstance_2().isRoute_h0e7uq_k$(_this__u8e3s4)) {
      // Inline function 'kotlin.check.<anonymous>' call
      var message = 'Check failed.';
      throw IllegalStateException_init_$Create$(toString(message));
    }
  ...
  protoOf(Router).renderActivePage$composable_ebhbpl_k$ = function (pageWrapper, $composer, $changed, $default) {
    ...
    if (tmp1_safe_receiver === null)
      ...
      tmp1_safe_receiver.updateScope_xhrf9y_k$(Router$renderActivePage$composable$lambda_0(this, pageWrapper_0, $changed, $default));
    }
  };
  protoOf(Router).register$composable_i4dkxg_k$ = function (route, autoPrefix, pageMethod) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(Companion_getInstance_2().isRoute_h0e7uq_k$(route) ? startsWith_0(route, _Char___init__impl__6a9atx(47)) : false)) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!this.routeTree_1.register$composable_vzmwjp_k$(prependIf(Companion_getInstance_3(), autoPrefix, route), pageMethod)) {
      // Inline function 'com.varabyte.kobweb.navigation.Router.register$composable.<anonymous>' call
