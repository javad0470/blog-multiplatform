...
fun applyControlStyle(
    ...
    when (editorControl) {
        EditorControl.Bold -> applyStyle(controlStyle = ControlStyle.Bold(selectedText = getSelectedText()))
        EditorControl.Italic -> applyStyle(controlStyle = ControlStyle.Italic(selectedText = getSelectedText()))
        EditorControl.Link -> onLinkClick()
        EditorControl.Title -> applyStyle(controlStyle = ControlStyle.Title(selectedText = getSelectedText()))
        EditorControl.SubTitle -> applyStyle(controlStyle = ControlStyle.SubTitle(selectedText = getSelectedText()))
        EditorControl.Quote -> applyStyle(controlStyle = ControlStyle.Quote(selectedText = getSelectedText()))
        EditorControl.Code -> applyStyle(controlStyle = ControlStyle.Code(selectedText = getSelectedText()))
