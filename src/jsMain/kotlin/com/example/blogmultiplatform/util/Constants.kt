...
object Constant {
    ...
    const val HUMOR_API_URL = "https://api.humorapi.com/jokes/random?api-key=c7a8af37711c486998963280498efadd&max-lenght=180"
}
...
object ID {
    const val usernameInputID = "username_input"
    const val passwordInputID = "password_input"
    ...
    const val linHrefInput = "linHrefInput"
    const val linTitleInput = "linTitleInput"
